...
public class EmergencyController {
    ...
    @Operation(summary = "Currently logged dispositor approves given request", security = @SecurityRequirement(name = "bearerAuth"))
    @PostMapping("/approve/{id}")
    public void approveEmergency(@RequestBody ApproveEmergencyRequest request, @PathVariable Integer id, Authentication authentication) {
